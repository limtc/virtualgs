/**
    GScript 1.1.4 - by Lim Thye Chean
...
function setGradient(x1, y1, x2, y2, color1, color2) {
    ...
    var c1 = "rgb(" + Math.floor(color1[0]) + "," + Math.floor(color1[1]) + "," + Math.floor(color1[2]) + ")";
    var c2 = "rgb(" + Math.floor(color2[0]) + "," + Math.floor(color2[1]) + "," + Math.floor(color2[2]) + ")";
