...
{document.write('<object id="id3" type="video/quicktime" width="320" height="216" style="height: 200px; left: 0px; position: absolute; top: 32px; width: 320px; z-index: 1; "><param name="src" value="Space_Game_2_files/Space.jpg"/><param name="target" value="myself"/><param name="href" value="../Media/Space.mp4"/><param name="controller" value="false"/><param name="scale" value="tofit"/></object>');}
else
...
{return false;}
function onPageLoad()
{loadMozillaCSS('Space_Game_2_files/Space_Game_2Moz.css')
